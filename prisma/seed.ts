...
async function main() {
  ...
  const mods: {
    ...
    { name: "Impulse Brake", type: "BARREL", rarity: "DELUXE", price: 180, description: "Increases stability and reduces flinch.", imageUrl: "https://static.wikia.nocookie.net/marathonthegame/images/b/bd/Impluse_Brake.png", compatibleWeapons: ["Hardline PR", "Repeater HPR", "Twin Tap HBR", "Stryder M1T", "B33 Volley Rifle", "Longshot", "Outland"], statModifiers: [{ stat: "stability", direction: "up", label: "Stability" }, { stat: "flinch", direction: "up", label: "Flinch Resistance" }] },
    ...
    { name: "Tru-shot Barrel", type: "BARREL", rarity: "ENHANCED", price: 60, description: "Slightly increases ADS accuracy.", compatibleWeapons: ["Hardline PR", "Repeater HPR", "Twin Tap HBR", "Stryder M1T", "B33 Volley Rifle", "V66 Lookout"], statModifiers: [{ stat: "adsSpread", direction: "up", label: "ADS Accuracy" }] },
    ...
    // --- GRIP (4) ---
    { name: "Combat Grip", type: "GRIP", rarity: "DELUXE", price: 180, description: "Increases ADS speed and ready speed.", imageUrl: "https://static.wikia.nocookie.net/marathonthegame/images/e/e2/Combat_Grip.png", compatibleWeapons: ["M77 Assault Rifle", "Overrun AR", "Impact HAR", "V75 Scar"], statModifiers: [{ stat: "adsSpeed", direction: "up", label: "ADS Speed" }, { stat: "equipSpeed", direction: "up", label: "Ready Speed" }] },
    ...
    { name: "Reloader Mag", type: "MAGAZINE", rarity: "ENHANCED", price: 0, description: "Slightly increases reload speed.", compatibleWeapons: ["Overrun AR", "M77 Assault Rifle", "Bully SMG", "Copperhead RF"], statModifiers: [{ stat: "reloadSpeed", direction: "up", label: "Reload Speed" }] },
    ...
    { name: "Steady Rounds", type: "MAGAZINE", rarity: "DELUXE", price: 207, description: "Increases stability and reduces recoil.", compatibleWeapons: ["Overrun AR", "M77 Assault Rifle", "Impact HAR", "Bully SMG", "Copperhead RF"], statModifiers: [{ stat: "stability", direction: "up", label: "Stability" }, { stat: "recoil", direction: "up", label: "Recoil" }] },
    { name: "Combat Mag", type: "MAGAZINE", rarity: "ENHANCED", price: 60, description: "Slightly increases reload speed and ready speed.", compatibleWeapons: ["Hardline PR", "Twin Tap HBR", "Stryder M1T", "B33 Volley Rifle"], statModifiers: [{ stat: "reloadSpeed", direction: "up", label: "Reload Speed" }, { stat: "equipSpeed", direction: "up", label: "Ready Speed" }] },
    ...
    // --- GENERATOR (2) ---
    { name: "Overclocked Generator", type: "GENERATOR", rarity: "PRESTIGE", price: 0, description: "A custom-made mod for the V00 Zeus RG. Greatly increases charge speed and damage. Overcharging the weapon fires a devastating blast.", compatibleWeapons: ["V00 Zeus RG"], statModifiers: [{ stat: "chargeTime", direction: "up", label: "Charge Speed" }, { stat: "damage", direction: "up", label: "Damage" }] },
    { name: "Stabilizing Generator", type: "GENERATOR", rarity: "SUPERIOR", description: "Greatly increases stability while charging.", compatibleWeapons: ["Ares RG", "V00 Zeus RG"], statModifiers: [{ stat: "stability", direction: "up", label: "Stability" }] },
    ...
    { name: "Bounty Hunter", type: "CHIP", rarity: "ENHANCED", price: 207, description: "Eliminating UESC pays you a small amount of credits.", isUniversal: true, compatibleWeapons: [] },
    { name: "Swarm Directive", type: "CHIP", rarity: "DELUXE", price: 0, description: "Precision eliminations with this weapon spawn a few flechette seekers that heal you when damaging hostiles.", isUniversal: true, compatibleWeapons: [] },
    ...
    { name: "Veilshot Chip", type: "CHIP", rarity: "ENHANCED", price: 60, description: "Kills with this weapon briefly cloak you.", compatibleWeapons: ["Conquest LMG"] },
    { name: "Background Process", type: "CHIP", rarity: "ENHANCED", price: 69, description: "When this weapon is stowed, it automatically reloads after a significant period of time.", isUniversal: true, compatibleWeapons: [] },
    { name: "Cloudborn", type: "CHIP", rarity: "ENHANCED", price: 0, description: "While airborne, this weapon has increased accuracy and stability.", isUniversal: true, compatibleWeapons: [], statModifiers: [{ stat: "accuracy", direction: "up", label: "Accuracy" }, { stat: "stability", direction: "up", label: "Stability" }] },
    { name: "Heatsink", type: "CHIP", rarity: "ENHANCED", price: 60, description: "Increases heat capacity, allowing sustained fire for longer.", isUniversal: true, compatibleWeapons: [], statModifiers: [{ stat: "heatCapacity", direction: "up", label: "Heat Capacity" }] },
    { name: "Insomniac", type: "CHIP", rarity: "ENHANCED", price: 0, description: "Sprint speed is slightly increased.", isUniversal: true, compatibleWeapons: [], statModifiers: [{ stat: "movementSpeed", direction: "up", label: "Sprint Speed" }] },
    { name: "Insurrection", type: "CHIP", rarity: "DELUXE", price: 0, description: "Damaging hostiles with this weapon increases your damage resistance briefly.", isUniversal: true, compatibleWeapons: [] },
    { name: "Keen Scout Chip", type: "CHIP", rarity: "ENHANCED", price: 60, description: "Increases radar range.", isUniversal: true, compatibleWeapons: [] },
    { name: "Motionsense Chip", type: "CHIP", rarity: "ENHANCED", price: 60, description: "Briefly highlights hostiles on your radar after taking damage.", isUniversal: true, compatibleWeapons: [] },
    { name: "Stack Overflow", type: "CHIP", rarity: "DELUXE", price: 23, description: "Rapidly defeating hostiles grants a stacking damage bonus.", isUniversal: true, compatibleWeapons: [] },
    ...
    { name: "Alternating Current", type: "CHIP", rarity: "ENHANCED", price: 69, description: "Restore a moderate amount of health or shields when damaging a target affected by EMP.", isUniversal: true, compatibleWeapons: [] },
  ];
  ...
  const ttkData: {
    ...
    { csvName: "BR33 VOLLEY RIFLE", weaponName: "B33 Volley Rifle", damage: 14.8, rpm: 481, headshotMultiplier: 1.4, headshotDamage: 20.72, range: 48, dps: 118.65, shotsToKill: "10B | 7C", ttkWhite: 1.123, ttkGreen: 1.247, ttkBlue: 1.497, ttkPurple: 1.622, ttkHeadWhite: 0.748, ttkHeadGreen: 0.873, ttkHeadBlue: 0.998, ttkHeadPurple: 1.123 },
    ...
    { csvName: "BRRT SMG", weaponName: "BRRT SMG", damage: 11, rpm: 1000, headshotMultiplier: 1.4, headshotDamage: 15.4, range: 27, dps: 183.33, shotsToKill: "13B | 10C", ttkWhite: 0.72, ttkGreen: 0.84, ttkBlue: 0.96, ttkPurple: 1.08, ttkHeadWhite: 0.54, ttkHeadGreen: 0.6, ttkHeadBlue: 0.66, ttkHeadPurple: 0.72 },
