...
async function main() {
  ...
  const mods: {
    ...
    // --- GENERATOR (2) ---
    { name: "Overclocked Generator", type: "GENERATOR", rarity: "PRESTIGE", price: 1620, description: "A custom-made mod for the V00 Zeus RG. Increases stability, accuracy when firing from the hip, and reduces charge time. Spartan Laser — This weapon fires two projectiles per trigger pull.", imageUrl: "https://static.wikia.nocookie.net/marathonthegame/images/4/4e/Overclocked_Generator.png", compatibleWeapons: ["V00 Zeus RG"], statModifiers: [{ stat: "recoil", direction: "up", label: "Stability" }, { stat: "hipfireSpread", direction: "up", label: "Accuracy" }, { stat: "chargeTime", direction: "up", label: "Charge Time" }] },
