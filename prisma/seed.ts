...
async function main() {
  ...
  const mods: {
    ...
    { name: "Battle Runner", type: "CHIP", rarity: "ENHANCED", price: 23, description: "Eliminations with this weapon grant a brief boost to sprint speed.", isUniversal: true, compatibleWeapons: [] },
